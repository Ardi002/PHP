...
function showRadioButtons() {
  ...
  for (
    let i = 1;
    i <= parseInt(document.getElementById("num-choices").value);
    i++
  ) {
...
function showResult() {
  ...
  // membuat output teks
  const output = `Halo, nama saya ${name}, saya mempunyai sejumlah ${
    choices.length
  } pilihan hobi yaitu ${choices.join(", ")}, dan saya menyukai ${choice}.`;
